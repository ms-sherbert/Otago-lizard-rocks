...
ggplot(data=data, aes(x=PostC,y=N)) +
  ...
  scale_x_continuous(name = "Number of years following rock pile construction") +
  ...
  annotate("text",x=PostC+0.1,y=data$N,label=data$N,color = "#006666",size=4) +
  annotate("text",x=PostC,y=data$UCI+20,label=c("Feb 2015","Mar 2016","Mar 2017"),color = "#66b2b2",size=3.5) 
